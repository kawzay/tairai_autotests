...
// todo тут немного больно как перфекционисту, что в некоторых местах есть пробелы внутри фигурных скобок,
//  а в некоторых нет, только самому это конечно руками менять это не надо,
//  можно линтер настроить либо хотя-бы в идешке нажать комбинацию автоформатирования
//  вроде любая поддерживает (option+command+l если мак)
